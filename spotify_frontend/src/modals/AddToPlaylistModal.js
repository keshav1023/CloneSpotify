...
const AddToPlaylistModal = ({ closeModal, addSongToPlaylist }) => {
  ...
  return (
    <div
      className="absolute bg-black w-screen h-screen bg-opacity-70 flex justify-center items-center"
      onClick={closeModal}
    >
      <div
...
const PlaylistListComponent = ({ info, addSongToPlaylist}) => {
  return (
    <div
      className="bg-app-black w-full flex items-center space-x-4 hover:bg-gray-400 hover:bg-opacity-20 p-3 cursor-pointer"
      onClick={() => {
